...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    {
        title: 'Ubah',
        href: '/admin/data-mahasiswa/{id}/ubah',
    },
];
...
export default function UbahMahasiswa({ mahasiswa }: { mahasiswa: MahasiswaForm }) {
    ...
    const handleDelete: FormEventHandler = (e) => {
        e.preventDefault();
        setDeleting(true);
        router.delete(route('admin.data-mahasiswa.destroy', mahasiswa.id), {
            onSuccess: () => {
                router.visit(route('admin.data-mahasiswa.index'));
            },
            onError: (error) => {
    ...
    const handleSubmit: FormEventHandler = (e) => {
        ...
        post(route('admin.data-mahasiswa.update', mahasiswa.id), {
            forceFormData: true,
            preserveState: true,
            preserveScroll: true,
            onSuccess: () => {
                ...
                router.visit(route('admin.data-mahasiswa.edit', mahasiswa.id));
            },
            onError: (errors) => {
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center justify-center max-w-sm mb-2 gap-4">
                        <Button variant="outline" asChild>
                            <Link href={`/admin/data-mahasiswa/${mahasiswa.id}`}><Eye />Lihat</Link>
                        </Button>
                        <AlertDialog>
