...
export function createPeminjamanKelasColumns(userRole?: string, canUpdate?: boolean, canDelete?: boolean): ColumnDef<PeminjamanKelas>[] {
    return createTableColumns<PeminjamanKelas>({
        ...
        actionConfig: {
            basePath: userRole + ".peminjaman-kelas.history",
