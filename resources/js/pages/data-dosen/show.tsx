...
export default function LihatDosen({ dosen, userRole, canUpdate }: { dosen: DosenData, userRole: string, canUpdate?: boolean }) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Lihat',
            href: `/${userRole}/data-dosen/${dosen.id}`,
        },
    ];
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    {canUpdate && (
                        <Button variant="outline" asChild>
                            <Link href={`/${userRole}/data-dosen/${dosen.id}/ubah`}><Pencil />Ubah</Link>
                        </Button>
                    )}
                </div>
