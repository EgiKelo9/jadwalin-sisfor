...
export default function UbahDosen({ dosen, userRole, canDelete }: { dosen: DosenForm, userRole: string, canDelete?: boolean }) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Ubah',
            href: `/${userRole}/data-dosen/${dosen.id}/ubah`,
        },
    ];
    ...
    const handleDelete: FormEventHandler = (e) => {
        e.preventDefault();
        setDeleting(true);
        router.delete(route(`${userRole}.data-dosen.destroy`, dosen.id), {
            onSuccess: () => {
                router.visit(route(`${userRole}.data-dosen.index`));
            },
            onError: (error) => {
    ...
    const handleSubmit: FormEventHandler = (e) => {
        ...
        post(route(`${userRole}.data-dosen.update`, dosen.id), {
            forceFormData: true,
            preserveState: true,
            preserveScroll: true,
            onSuccess: () => {
                ...
                router.visit(route(`${userRole}.data-dosen.edit`, dosen.id));
            },
            onError: (errors) => {
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    <div className="flex items-center justify-center max-w-sm mb-2 gap-4">
                        <Button variant="outline" asChild>
                            <Link href={`/${userRole}/data-dosen/${dosen.id}`}><Eye />Lihat</Link>
                        </Button>
                        {canDelete && (
                            <AlertDialog>
