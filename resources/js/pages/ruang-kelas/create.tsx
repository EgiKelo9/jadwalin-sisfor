...
export default function BuatRuangKelas({ userRole }: { userRole: string }) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Buat',
            href: `/${userRole}/ruang-kelas/buat`,
        },
    ];
    ...
    const submit: FormEventHandler = (e) => {
        e.preventDefault();
        post(route(`${userRole}.ruang-kelas.store`), {
            forceFormData: true,
            onSuccess: () => {
                reset();
            },
        ...
        <AppLayout breadcrumbs={breadcrumbs} userRole={userRole}>
            ...
            <form className="flex h-full w-full flex-1 flex-col gap-4 rounded-xl p-4 overflow-x-auto" onSubmit={submit}>
                ...
                <div className='flex gap-4 mt-2'>
                    <Button type="submit" variant={"primary"} tabIndex={6} disabled={processing}>
                        {processing ?
