...
export default function LihatMataKuliah({ mataKuliah, userRole, canUpdate }: { mataKuliah: MataKuliahData, userRole: string, canUpdate?: boolean }) {
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Lihat',
            href: `/${userRole}/mata-kuliah/${mataKuliah.id}`,
        },
    ];
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                    ...
                    {canUpdate && (
                        <Button variant="outline" asChild>
                            <Link href={`/${userRole}/mata-kuliah/${mataKuliah.id}/ubah`}><Pencil />Ubah</Link>
                        </Button>
                    )}
                </div>
