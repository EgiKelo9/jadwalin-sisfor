...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->string('role')->default('mahasiswa'); // Default role is mahasiswa
            $table->foreignId('mahasiswa_id')->nullable()->constrained('mahasiswas')->cascadeOnDelete()->cascadeOnUpdate();
